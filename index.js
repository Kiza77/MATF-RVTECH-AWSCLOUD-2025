...
const ALLOWED_ORIGIN = 'http://chargers-website.s3-website.localhost.localstack.cloud:4566';
const corsHeaders = {
...
exports.syncOCMdata = async () => {
  ...
  try {
    ...
    return {
      statusCode: 200,
      headers: { 'Access-Control-Allow-Origin': 'http://chargers-website.s3-website.localhost.localstack.cloud:4566' },
      body: JSON.stringify({
